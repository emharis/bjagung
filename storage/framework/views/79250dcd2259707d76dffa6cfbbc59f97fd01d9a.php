                ...
                <tbody>
                    ...
                    <?php foreach($data as $dt): ?>
                        <tr data-dataid="<?php echo e($dt->id); ?>" data-rowid="<?php echo e($rownum); ?>">
                            ...
                            <td>
                                <?php echo e($dt->inventory_reference); ?>

                            </td>
                            <td>
                                <?php echo e(date('d-m-Y',strtotime($dt->tgl))); ?>

                            </td>
                            <td>
                                <?php if($dt->status == 'D'): ?>
                                    Draft
                                <?php elseif($dt->status == 'P'): ?>
                                    In Progress
                                <?php else: ?>
                                    Validated
                                <?php endif; ?>
                            ...
                            <td>
                                <a class="btn btn-success btn-xs btn-edit-barang" href="inventory/adjustment/edit/<?php echo e($dt->id); ?>" ><i class="fa fa-edit" ></i></a>
                                <?php if($dt->status != 'V'): ?>
