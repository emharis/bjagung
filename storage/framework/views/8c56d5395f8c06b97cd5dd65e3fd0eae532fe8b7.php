    ...
    <div class="nav-tabs-custom">
        ...
        <div class="box-body">
          ...
          <div class="tab-pane" id="tab_2">
            ...
            <?php if($sup_bill->status == 'O'): ?>
                <a class="btn btn-primary" id="btn-reg-payment" href="invoice/supplier-bill/reg-payment/<?php echo e($sup_bill->id); ?>" >Register Payment</a>
                <br/>
            ...
            <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <?php foreach($payments as $dt): ?>
                        <tr  >
                            <td class="text-right" ><?php echo e($rownum++); ?></td>
                            <td><?php echo e($dt->payment_date_formatted); ?></td>
                            <td><?php echo e($dt->payment_number); ?></td>
                            <td class="text-right" ><?php echo e(number_format($dt->total,0,'.',',')); ?></td>
                            <td>
                                <a class="btn btn-xs btn-danger btn-delete-payment" href="invoice/supplier-bill/delete-payment/<?php echo e($dt->id); ?>" ><i class="fa fa-trash-o" ></i></a>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-right" >
                            <?php echo e(number_format($total_payment_amount,0,'.',',')); ?>
