    ...
    <script type="text/javascript">
        (function ($) {
            ...
            function hitungJumlahHargaBarangOnRowOnChange(row){
                var qty = row.children('td:first').next().next().next().children('input').val();
                var qty_col = row.children('td:first').next().next().next();
            ...
            $('#btn-save').click(function(){
                ...
                $('.row-barang').each(function(i){
                    ...
                    var nama_barang = br_row.children('td:first').text();
                    var kode = br_row.data('kodebarang');
                    var qty = br_row.children('td:first').next().next().next().children('input').val();
                    var harga_satuan = br_row.children('td:first').next().text();
                    harga_satuan = harga_satuan.replace(/\./g, "");
                    harga_satuan = harga_satuan.replace(/,/g, "");

                    var harga_salesman = br_row.children('td:first').next().next().children('input').val();
                    harga_salesman = harga_salesman.replace(/\./g, "");
                    harga_salesman = harga_salesman.replace(/,/g, "");

                    var current_stok = br_row.children('td:first').children('label').text();
